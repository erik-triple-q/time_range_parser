...
```json
{
  ...
  "start": "2026-02-04T00:00:00+01:00",
...
```json
{
  "input": "morgen 15:00",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-04T15:00:00+01:00",
  "end": "2026-02-04T16:00:00+01:00",
...
```json
{
  "input": "van 10:00 tot 12:30",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-03T10:00:00+01:00",
  "end": "2026-02-03T12:30:00+01:00",
  "kind": "explicit_range"
}
```
...
```json
{
  "input": "morgen 2 uur",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-04T02:00:00+01:00",
  "end": "2026-02-04T03:00:00+01:00",
  "kind": "time_with_default_duration"
}
```
...
```json
{
  "input": "van 22:00 tot 02:00",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-03T22:00:00+01:00",
  "end": "2026-02-04T02:00:00+01:00",
  "kind": "explicit_range"
}
```
...
```json
{
  "input": "straks",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-03T10:04:09+01:00",
  "end": "2026-02-03T11:04:09+01:00",
  "kind": "vague_time"
}
```
...
```json
{
  "input": "vanavond",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-03T20:00:00+01:00",
  "end": "2026-02-03T22:00:00+01:00",
  "kind": "vague_time"
}
```
...
```json
{
  "input": "morgenochtend",
  "timezone": "Europe/Amsterdam",
  "start": "2026-02-04T06:00:00+01:00",
  "end": "2026-02-04T11:59:59+01:00",
  "kind": "compound_day"
}
```
...
```json
{
  ...
  "dates": [
    "2026-02-03T08:04:12.972423+01:00",
    "2026-02-04T08:04:12.972423+01:00",
    "2026-02-05T08:04:12.972423+01:00"
  ]
}
```
...
```json
{
  ...
  "dates": [
    "2026-02-03T08:04:13.173406+01:00",
    "2026-02-17T08:04:13.173406+01:00",
    "2026-03-03T08:04:13.173406+01:00"
  ]
}
```
...
```json
{
  ...
  "dates": [
    "2026-02-03T08:04:13.380400+01:00",
    "2026-03-03T08:04:13.380400+01:00"
  ]
}
```
...
```json
{
  ...
  "timezone": "Europe/Amsterdam",
  "start_iso": "2026-02-03T00:00:00+01:00",
  "end_iso": "2026-02-13T00:00:00+01:00",
  "duration": {
    "total_days": 10.0,
    "total_seconds": 864000.0,
    "business_days": 8,
    "human_readable": "1 week 3 days"
  }
}
```
...
```json
{
  ...
  "timezone": "Europe/Amsterdam",
  "start_iso": "2026-02-03T00:00:00+01:00",
  "end_iso": "2026-02-10T00:00:00+01:00",
  "duration": {
    "total_days": 7.0,
    "total_seconds": 604800.0,
    "business_days": 5,
    "human_readable": "1 week"
  }
}
```
...
**Input**: `22:00`
- **Arguments**: `text=22:00`, `source_timezone=cairo`, `target_timezone=sydney`
- **Result**:
```json
{
  "input": "22:00",
  ...
  "source_start": "2026-02-03T22:00:00+02:00",
  "target_start": "2026-02-04T07:00:00+11:00",
  "source_end": "2026-02-03T23:00:00+02:00",
  "target_end": "2026-02-04T08:00:00+11:00",
  "utc_offset_diff_hours": 9.0
}
```
...
**Input**: `now`
- **Arguments**: `text=now`, `source_timezone=UTC`, `target_timezone=kolkata`
- <span style="color:red;">**Tool Error**</span>:
```json
{
  "error": "'StaticTzInfo' object has no attribute 'zone'"
}
```
...
**Input**: `12:00`
- **Arguments**: `text=12:00`, `source_timezone=Amsterdam`, `target_timezone=Mars/City`
- <span style="color:red;">**Tool Error**</span>:
```json
{
  "error": "Mars/City"
